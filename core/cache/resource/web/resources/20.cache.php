<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1546792035,
    'editedby' => 1,
    'editedon' => 1546793418,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1546792020,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'otziv',
      1 => '[{"MIGX_id":"1","name_otziv":"Глянцевый потолок, Минск","text_otziv":"Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв ","active_otziv":"1"},{"MIGX_id":"2","name_otziv":"Глянцевый потолок, Минск","text_otziv":"Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв ","active_otziv":"1"},{"MIGX_id":"3","name_otziv":"Глянцевый потолок, Минск","text_otziv":"Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв ","active_otziv":"1"},{"MIGX_id":"4","name_otziv":"Глянцевый потолок, Минск","text_otziv":"Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв ","active_otziv":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
...
<link rel="canonical" href="http://greenlubos.lt/otzyivyi" />
<title>Отзывы</title>
...
<li class="woo-login landing_footer_menu_list_language_link_wrapper current-menu-item current_page_item">
    <a href="http://greenlubos.lt/otzyivyi" class="ru babellinks item">
...
<li class="woo-login landing_footer_menu_list_language_link_wrapper ">
    <a href="http://greenlubos.lt/lt/atsiliepimai" class="lt babellinks item">
...
<section class="page-title" >
   <div class="container">
      <div class="row">
         <div class="col-xs-12">
            <h2>Отзывы</h2>
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li>Отзывы</li></ol>	
         </div>
      </div>
   </div>
</section>

<section class="testm-section-5 grey-bg pagetoppadd">
   <div class="container">
      <div class="row">
[[!AjaxForm?
	&snippet=`FormIt`
	&form=`tpl.AjaxForm.otziv`
    ...
    &formName=`Отзыв с сайта`
    &formFields=`name,message`
    &fieldNames=`name==Имя,message==Отзыв`
    &validate=`name:minLength=^3^,message:minLength=^12^,user:blank,username:blank,captcha:blank`
	&validationErrorMessage=`В форме содержатся ошибки!`
	&successMessage=`Ваша отзыв принят!`
]]           
         ...
         <div class="col-sm-6">
            <div class="testbox">
               <div class="client_msg">
                  ...
                  <p>Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв </p>
                  <div class="client_desc"><span class="client_name">Глянцевый потолок, Минск</span></div>
               </div>
               <div class="client_info">
                  <span class="client_image"><img src="../assets/images/kart/pariashie-potolki.jpg" alt="Глянцевый потолок, Минск"></span>
               </div>
            </div>
...
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li>Отзывы</li></ol>	
    ...
    '[[$lang? &ru=`Ваша отзыв принят!` &lt=`Jūsų atsiliepimas patvirtintas!`]]' => 'Ваша отзыв принят!',
    '[[getImageList? &tvname=`otziv` &tpl=`otziv.tpl` &limit=`0` &where=`{"active_otziv":"1"}`]]' => '         <div class="col-sm-6">
            <div class="testbox">
               <div class="client_msg">
                  <span class="quoteicon"><i class="fa fa-quote-left"></i></span>
                  <p>Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв Отзыв </p>
...
',
    '[[$lang? &ru=`Оставить отзыв` &lt=`Palikti atsiliepimą`]]' => 'Оставить отзыв',
    '[[~20? &scheme=`full`]]' => 'http://greenlubos.lt/otzyivyi',
