<?php  return array (
  ...
  array (
    ...
    'longtitle' => 'OOPPS! СТРАНИЦА, КОТОРУЮ ВЫ ИСКАЛИ, НЕ СУЩЕСТВУЕТ',
    'description' => '',
    'alias' => 'oshibka-404',
    'alias_visible' => 1,
    'link_attributes' => '',
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p style="text-align: center;">Вы можете вернуться на главную страницу</p>
',
    'richtext' => 1,
    'template' => 3,
    'menuindex' => 10,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1522315494,
    'editedby' => 1,
    'editedon' => 1546770592,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1522315440,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'show_in_tree' => 1,
    'properties' => '{"stercseo":{"index":"1","follow":"1","sitemap":"0","priority":"0.5","changefreq":"weekly"}}',
...
<link rel="canonical" href="http://greenlubos.lt/oshibka-404" />
<title>OOPPS! СТРАНИЦА, КОТОРУЮ ВЫ ИСКАЛИ, НЕ СУЩЕСТВУЕТ</title>
...
<li class="woo-login landing_footer_menu_list_language_link_wrapper current-menu-item current_page_item">
    <a href="http://greenlubos.lt/oshibka-404" class="ru babellinks item">
...
<li class="woo-login landing_footer_menu_list_language_link_wrapper ">
    <a href="http://greenlubos.lt/lt/klaida-404" class="lt babellinks item">
...
<section class="page-title" >
   <div class="container">
      <div class="row">
         <div class="col-xs-12">
            <h2>Ошибка 404</h2>
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li>Ошибка 404</li></ol>	
         </div>
      </div>
   </div>
</section>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="notfound-content">
               <h1>404</h1>
               <h3>OOPPS! СТРАНИЦА, КОТОРУЮ ВЫ ИСКАЛИ, НЕ СУЩЕСТВУЕТ</h3>
<p style="text-align: center;">Вы можете вернуться на главную страницу</p>

               <a href="http://greenlubos.lt/" class="btn-style1">Перейти на главную страницу</a>
            </div>
         </div>
      </div>
   </div>
...
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li>Ошибка 404</li></ol>	
    ...
    '[[$lang? &ru=`Перейти на главную страницу` &lt=`Pagrindinis puslapis`]]' => 'Перейти на главную страницу',
...
',
    '[[~2? &scheme=`full`]]' => 'http://greenlubos.lt/oshibka-404',
