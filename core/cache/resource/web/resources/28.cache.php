<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Матовые потолки',
    'longtitle' => '',
    'description' => '',
    'alias' => 'matovyie-potolki',
    'alias_visible' => 0,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Матовый натяжной потолок – это высокое качество и низкая цена. Покупатель всегда обращает внимание на стоимость. Доступная цена формируется из – за повышенного спроса на этот тип отделки. Матовый натяжной потолок создается из пленки ПВХ. Материал обладает высокой эластичностью и влагостойкостью. За счет этого натяжные потолки данного типа не пропускают воду. Монтаж потолка можно проводить в комнатах с высокой влажностью.</p>

<p>Производители это учитывают. Спрос порождает новые подходы к производству. Покупатель – главное лицо в этом процессе.</p>
',
    'richtext' => 1,
    'template' => 6,
    'menuindex' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'natyazhnyie-potolki/matovyie-potolki',
    'uri_override' => 0,
    ...
    array (
      0 => 'images',
      1 => 'фото потолков/51080260_377380689730649_2432639763870646272_n (1).jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'opiskateg',
      1 => '<h4>Матовые натяжные потолки</h4>
...
',
    ...
    array (
      0 => 'slidePotol',
      1 => '[{"MIGX_id":"1","slider_potol":"фото потолков/20170306_142432.jpg","active_potol":"1"},{"MIGX_id":"2","slider_potol":"photo_2019-02-10_20-28-59.jpg","active_potol":"1"},{"MIGX_id":"3","slider_potol":"photo_2019-02-10_20-27-59.jpg","active_potol":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'posledRaboty',
      1 => '[{"MIGX_id":"1","slider_Raboty":"photo_2019-02-10_20-28-59.jpg","active_Raboty":"1"},{"MIGX_id":"2","slider_Raboty":"photo_2019-02-10_20-26-34.jpg","active_Raboty":"1"},{"MIGX_id":"3","slider_Raboty":"photo_2019-02-10_20-26-11.jpg","active_Raboty":"1"},{"MIGX_id":"4","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e \\u043f\\u043e\\u0442\\u043e\\u043b\\u043a\\u043e\\u0432\\/20170306_142432.jpg","active_Raboty":"1"},{"MIGX_id":"5","slider_Raboty":"photo_2019-02-10_20-28-18.jpg","active_Raboty":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'texts',
      1 => '<p>Наиболее удачно матовые потолки смотрятся в следующих помещениях<br />
...
<link rel="canonical" href="http://greenlubos.lt/natyazhnyie-potolki/matovyie-potolki" />
<title>Матовые потолки</title>
...
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li><a href="natyazhnyie-potolki/">Потолки</a></li> / <li>Матовые потолки</li></ol>	
         </div>
      </div>
   </div>
</section>
...
[[!AjaxForm?
    ...
    &formName=`Сообщение Матовые потолки`
	...
	&successMessage=`Ваша заявка принята! Наш менеджер свяжется с вами в ближайшее время.`
      ...
      <div class="service-content">
         ...
         <p>Матовый натяжной потолок – это высокое качество и низкая цена. Покупатель всегда обращает внимание на стоимость. Доступная цена формируется из – за повышенного спроса на этот тип отделки. Матовый натяжной потолок создается из пленки ПВХ. Материал обладает высокой эластичностью и влагостойкостью. За счет этого натяжные потолки данного типа не пропускают воду. Монтаж потолка можно проводить в комнатах с высокой влажностью.</p>

<p>Производители это учитывают. Спрос порождает новые подходы к производству. Покупатель – главное лицо в этом процессе.</p>

         <blockquote><p>Наиболее удачно матовые потолки смотрятся в следующих помещениях<br />
<strong>В кухню - В коридор - В ванную - В санузел</strong></p>
 </blockquote>
...
<ul>
	...
	<p>Плотность: 449г/м2</p>
            ...
            <div class="col-sm-4">
               <img src="/assets/cache_image/фото потолков/51080260_377380689730649_2432639763870646272_n (1)_360x215_708.jpg" alt="Матовые потолки">
            </div>
            <div class="col-sm-4">
...
Назовем конечную стоимость натяжного потолка "под ключ"</p>
    ...
    <div class="preletitem">
                        <img src="/assets/cache_image/photo_2019-02-10_20-28-59_285x190_109.jpg" alt="Матовые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/photo_2019-02-10_20-26-34_285x190_109.jpg" alt="Матовые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/photo_2019-02-10_20-26-11_285x190_109.jpg" alt="Матовые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фото потолков/20170306_142432_285x190_109.jpg" alt="Матовые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/photo_2019-02-10_20-28-18_285x190_109.jpg" alt="Матовые потолки" />
                    </div>
                </div>
...
',
    ...
    '[[~28? &scheme=`full`]]' => 'http://greenlubos.lt/natyazhnyie-potolki/matovyie-potolki',
