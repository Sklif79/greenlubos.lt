<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Потолки с фотопечатью',
    'longtitle' => '',
    'description' => '',
    'alias' => 'potolki-s-fotopechatyu',
    'alias_visible' => 0,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p style="text-align: justify;">Натяжные потолки с фотопечатью воплотят любые фантазии покупателя. Создание дизайна потолка данного типа не имеет границ. Это особый потолок. Он играет ключевую роль в интерьере помещения. Фотопечать придает комнате оригинальность, стильность, эксклюзивность. Это происходит за счет особой технологии нанесения рисунка, способа печати, краски. В качестве рисунка можно использовать любое решение. Покупатель сам может предложить исходный материал – фото, изображения, эскизы. Дизайнер воплотит все в реальность.</p>

<p style="text-align: justify;">Цена натяжного потолка с фотопечатью формируется с учетом пожеланий покупателя.</p>
',
    'richtext' => 1,
    'template' => 6,
    'menuindex' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'natyazhnyie-potolki/potolki-s-fotopechatyu',
    'uri_override' => 0,
    ...
    array (
      0 => 'images',
      1 => 'фотопечать/50597959_576174412848172_7615519551781863424_n.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'opiskateg',
      1 => '<h4>Натяжные потолки с фотопечатью</h4>

<ul>
	<li>
	<p>Производитель: Descor</p>
	</li>
	<li>
	<p>Ширина печати без шва: 2,7-3,2м</p>
	</li>
	<li>
	<p>Печать на пленке и полотнах</p>
	</li>
	<li>
	<p>Нанесение: УФ печать</p>
	</li>
</ul>
',
      2 => 'default',
    ...
    array (
      0 => 'slidePotol',
      1 => '[{"MIGX_id":"1","slider_potol":"фотопечать/51522697_499063080622925_9094677787121287168_n.jpg","active_potol":"1"},{"MIGX_id":"2","slider_potol":"фотопечать/51555031_1941984762567597_967691934636179456_n.jpg","active_potol":"1"},{"MIGX_id":"3","slider_potol":"фотопечать/52065940_1073879269463634_4771246127942991872_n.jpg","active_potol":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'posledRaboty',
      1 => '[{"MIGX_id":"1","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e\\u043f\\u0435\\u0447\\u0430\\u0442\\u044c\\/50597959_576174412848172_7615519551781863424_n.jpg","active_Raboty":"1"},{"MIGX_id":"2","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e\\u043f\\u0435\\u0447\\u0430\\u0442\\u044c\\/51522697_499063080622925_9094677787121287168_n.jpg","active_Raboty":"1"},{"MIGX_id":"3","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e\\u043f\\u0435\\u0447\\u0430\\u0442\\u044c\\/51555031_1941984762567597_967691934636179456_n.jpg","active_Raboty":"1"},{"MIGX_id":"4","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e\\u043f\\u0435\\u0447\\u0430\\u0442\\u044c\\/52065940_1073879269463634_4771246127942991872_n.jpg","active_Raboty":"1"},{"MIGX_id":"5","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e\\u043f\\u0435\\u0447\\u0430\\u0442\\u044c\\/52599337_1948601311933591_599868495865315328_n.jpg","active_Raboty":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'texts',
      1 => 'Наиболее удачно потолки с фотопечатью смотрятся в следующих помещениях<br />
<strong>В кухню - В коридор - В ванную - В санузел</strong>',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
    ...
    array (
      0 => 'texts2',
      1 => '<p style="text-align: justify;">Поможем Вам определиться с дизайном, фактурой и технологией потолка<br />
Покажем каталог с образцами полотен и светильников<br />
Произведем замер помещения<br />
Назовем конечную стоимость натяжного потолка "под ключ"</p>
',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
...
<html lang="ru">
<head>
<base href="http://greenlubos.lt/" />
<meta name="robots" content="index,follow" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<link rel="canonical" href="http://greenlubos.lt/natyazhnyie-potolki/potolki-s-fotopechatyu" />
<title>Потолки с фотопечатью</title>
                    ...
                    <div class="top_infowrp top-left">
                        <ul class="top_infoitem">
                         <!--    <li><a>Добро Пожаловать</a></li> -->
                            [[!getImageList? &docid=`1` &tvname=`phone` &tpl=`@CODE:<li><a href="tel:[[+phone]]"><span class="fa flaticon-phone-call"></span>[[+phone]] [[+phone_name]] </a></li>` &limit=`2`]]
...
<li><button type="button" class="btn btn-modals" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="fa fa-user-circle" aria-hidden="true"></i> Вызвать замерщика на дом</button></li>
<li><button type="button" class="btn btn-modals" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="fa fa-phone" aria-hidden="true"></i> Заказать обратный звонок</button></li>
            ...
            <div class="middle_header">
                <div class="fluid-container ">
                    <div class="mdlheader-wrp clearfix">
                        <div class="main-logo">
                            <div class="logo">
                                <a href="http://greenlubos.lt/"><img src="/assets/cache_image/logo/Logopit_1548531711198_264x90_c5c.png" alt="Logo" title="Logo"></a>
                            </div>
                        </div>
    ...
    <a href="http://greenlubos.lt/lt/lubos-su-foto-tapetu" class="lt babellinks item">
         <img alt="" src="../assets/images/flagi/lang_lt.jpg" />
                ...
                <div class="container">
                    <!--Logo-->
                    <div class="logo">
                        <a href="http://greenlubos.lt/" class="img-responsive"><img src="/assets/cache_image/logo/Logopit_1548531711198_219x52_9eb.png" alt="Logo" title="Logo"></a>
                    </div>
...
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li><a href="natyazhnyie-potolki/">Потолки</a></li> / <li>Потолки с фотопечатью</li></ol>	
         </div>
      </div>
   </div>
</section>
...
<section class="service-details pagetoppadd">
   <div class="container">
<div class="servicetoplink"><ul><li><a href="natyazhnyie-potolki/dvuxurovnevyie-potolki-s-podsvetkoj" >Потолки с подсветкой</a></li><li><a href="natyazhnyie-potolki/glyanczevyie-potolki" >Глянцевые потолки</a></li><li><a href="natyazhnyie-potolki/satinovyie-potolki" >Сатиновые потолки</a></li><li><a href="natyazhnyie-potolki/tkanevyie-potolki" >Тканевые потолки</a></li><li><a href="natyazhnyie-potolki/dvuxurovnevyie-potolki" >Двухуровневые потолки</a></li><li><a href="natyazhnyie-potolki/reznyie-potolki" >Резные потолки</a></li><li><a href="natyazhnyie-potolki/matovyie-potolki" >Матовые потолки</a></li><li><a href="natyazhnyie-potolki/eksklyuzivnyie-natyazhnyie-potolki" >Эксклюзивные потолки </a></li></ul></div>
      <div class="row">
         <div class="col-md-8 col-sm-7 col-xs-12">
                        <div class="serv-image servdtlslide">
<img class="card-img-top" src="/assets/cache_image/фотопечать/51522697_499063080622925_9094677787121287168_n_750x450_cb8.jpg" alt="Потолки с фотопечатью"><img class="card-img-top" src="/assets/cache_image/фотопечать/51555031_1941984762567597_967691934636179456_n_750x450_cb8.jpg" alt="Потолки с фотопечатью"><img class="card-img-top" src="/assets/cache_image/фотопечать/52065940_1073879269463634_4771246127942991872_n_750x450_cb8.jpg" alt="Потолки с фотопечатью">
                        </div>
                    </div>
[[!AjaxForm?
	&snippet=`FormIt`
    ...
    &formName=`Сообщение Потолки с фотопечатью`
	...
	&successMessage=`Ваша заявка принята! Наш менеджер свяжется с вами в ближайшее время.`
]]           
      ...
      <div class="service-content">
         ...
         <p style="text-align: justify;">Натяжные потолки с фотопечатью воплотят любые фантазии покупателя. Создание дизайна потолка данного типа не имеет границ. Это особый потолок. Он играет ключевую роль в интерьере помещения. Фотопечать придает комнате оригинальность, стильность, эксклюзивность. Это происходит за счет особой технологии нанесения рисунка, способа печати, краски. В качестве рисунка можно использовать любое решение. Покупатель сам может предложить исходный материал – фото, изображения, эскизы. Дизайнер воплотит все в реальность.</p>

<p style="text-align: justify;">Цена натяжного потолка с фотопечатью формируется с учетом пожеланий покупателя.</p>

         <blockquote>Наиболее удачно потолки с фотопечатью смотрятся в следующих помещениях<br />
<strong>В кухню - В коридор - В ванную - В санузел</strong> </blockquote>
...
<div class="col-sm-6 col-md-4">
                        ...
                        <div class="feature_boxwrp">
                            <div class="feature_box">
                                ...
                                <p>Монтаж под ключ включен в стоимость</p>
                                <a class="gobtn"></a>
                            </div>
                        </div>
                    </div><div class="col-sm-6 col-md-4">
                        <div class="feature_boxwrp">
                            <div class="feature_box">
                                ...
                                <h4>Гарантия 25 лет</h4>
                                <p>Гарантия от производителя 25 лет</p>
                                <a class="gobtn"></a>
                            </div>
                        </div>
                    </div>
         ...
         <div class="list-frame row">
            <div class="col-sm-4">
               <h4>Натяжные потолки с фотопечатью</h4>
...
<ul>
	...
	<p>Нанесение: УФ печать</p>
            ...
            <div class="col-sm-4">
               <img src="/assets/cache_image/фотопечать/50597959_576174412848172_7615519551781863424_n_360x215_708.jpg" alt="Потолки с фотопечатью">
            </div>
            <div class="col-sm-4">
               <p style="text-align: justify;">Поможем Вам определиться с дизайном, фактурой и технологией потолка<br />
Покажем каталог с образцами полотен и светильников<br />
Произведем замер помещения<br />
Назовем конечную стоимость натяжного потолка "под ключ"</p>
    ...
    <div class="preletitem">
                        <img src="/assets/cache_image/фотопечать/50597959_576174412848172_7615519551781863424_n_285x190_109.jpg" alt="Потолки с фотопечатью" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фотопечать/51522697_499063080622925_9094677787121287168_n_285x190_109.jpg" alt="Потолки с фотопечатью" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фотопечать/51555031_1941984762567597_967691934636179456_n_285x190_109.jpg" alt="Потолки с фотопечатью" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фотопечать/52065940_1073879269463634_4771246127942991872_n_285x190_109.jpg" alt="Потолки с фотопечатью" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фотопечать/52599337_1948601311933591_599868495865315328_n_285x190_109.jpg" alt="Потолки с фотопечатью" />
                    </div>
                </div>
        ...
        <div class="stripcontact container">
			<div class="stripcontwrp">
				<ul class="clearfix">
					<li><i class="flaticon-placeholder"></i><strong>Адрес:</strong>Lithuania, Vilnius </li>
					<li><i class="flaticon-telephone"></i><strong>Телефон:</strong> [[!getImageList? &docid=`1` &tvname=`phone` &tpl=`@CODE: [[+phone]] [[+phone_name]] <br />` &limit=`2`]]</li>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="footer-box  footer-logo">
                            <a class="ftlogo" href="http://greenlubos.lt/">
                    ...
                    <div class="col-md-3 col-md-offset-0 col-sm-4">
                        <div class="footer-box quick-links">
                            <h3 class="title">Натяжные потолки</h3>
<ul><li><a href="natyazhnyie-potolki/glyanczevyie-potolki" >Глянцевые потолки</a></li><li><a href="natyazhnyie-potolki/satinovyie-potolki" >Сатиновые потолки</a></li><li><a href="natyazhnyie-potolki/matovyie-potolki" >Матовые потолки</a></li><li><a href="natyazhnyie-potolki/tkanevyie-potolki" >Тканевые потолки</a></li><li><a href="natyazhnyie-potolki/potolki-s-fotopechatyu" >Потолки с фотопечатью</a></li><li><a href="natyazhnyie-potolki/dvuxurovnevyie-potolki" >Двухуровневые потолки</a></li><li><a href="natyazhnyie-potolki/dvuxurovnevyie-potolki-s-podsvetkoj" >Потолки с подсветкой</a></li><li><a href="natyazhnyie-potolki/paryashhie-potolki" >Парящие потолки</a></li><li><a href="natyazhnyie-potolki/konturnyie-potolki" >Контурные потолки</a></li><li><a href="natyazhnyie-potolki/reznyie-potolki" >Резные потолки</a></li><li><a href="natyazhnyie-potolki/eksklyuzivnyie-natyazhnyie-potolki" >Эксклюзивные потолки </a></li><li><a href="natyazhnyie-potolki/paryashhie-linii" >Парящие линии</a></li></ul>
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-4">
                        <div class="footer-box quick-links">
                            <h3 class="title">Меню</h3>
<ul><li><a href="/" >Главная</a></li><li><a href="natyazhnyie-potolki/" >Потолки</a></li><li><a href="akczii-i-novosti/" >Акции</a></li><li><a href="uslugi/" >Услуги</a></li><li><a href="led-paneli" >LED панели</a></li><li><a href="otzyivyi" >Отзывы</a></li><li><a href="galereya" >Галерея</a></li><li><a href="chasto-zadavaemyie-voprosyi/" >Вопросы</a></li><li><a href="kontaktnaya-informacziya" >Контакты</a></li></ul>
                        </div>
                    </div>
...
',
  ...
  'elementCache' => 
  array (
    '[[MetaX?tpl=`metax-html5`]]' => '<base href="http://greenlubos.lt/" />
<meta name="robots" content="index,follow" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<link rel="canonical" href="http://greenlubos.lt/natyazhnyie-potolki/potolki-s-fotopechatyu" />
<title>Потолки с фотопечатью</title>
...
<!-- bootstrap v3.3.6 css -->
    ...
    '[[$lang? &ru=`Вызвать замерщика на дом` &lt=`Inžineriaus iškvietimas į namus`]]' => 'Вызвать замерщика на дом',
    '[[$lang? &ru=`Заказать обратный звонок` &lt=`Atgalinio skambučio užsakymas`]]' => 'Заказать обратный звонок',
...
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li><a href="natyazhnyie-potolki/">Потолки</a></li> / <li>Потолки с фотопечатью</li></ol>	
    ...
    '[[BabelTranslation? &contextKey=`web` &resourceId=`14`]]' => 14,
    '[[pdoMenu?
	&parents=`14`
	&level=`1`
	&showHidden=`0`
    ...
    '[[$lang? &ru=`В форме содержатся ошибки!` &lt=`Formoje yra klaidų!`]]' => 'В форме содержатся ошибки!',
    '[[$lang? &ru=`Ваша заявка принята! Наш менеджер свяжется с вами в ближайшее время.` &lt=`Jūsų prašymas priimtas! Mūsų vadybininkas susisieks su jumis artimiausiu metu.`]]' => 'Ваша заявка принята! Наш менеджер свяжется с вами в ближайшее время.',
    '[[$lang? &ru=`С нами выгодно` &lt=`Su mumis apsimoka`]]' => 'С нами выгодно',
    '[[getImageList? &docid=`1` &tvname=`vigoda` &tpl=`vigoda.tpl` &limit=`3` &where=`{"active_vigoda":"1"}`]]' => '<div class="col-sm-6 col-md-4">
                        <div class="feature_boxwrp">
                            <div class="feature_box">
                                <div class="icon_box"><span class="flaticon-drawing"></span></div>
                                <h4>Замер</h4>
    ...
    '[[$lang? &ru=`Наши последние работы` &lt=`Mūsų paskutiniai darbai`]]' => 'Наши последние работы',
...
',
    '[[$lang? &ru=`Адрес` &lt=`Adresas`]]' => 'Адрес',
    '[[$lang? &ru=`Телефон` &lt=`Telefonas`]]' => 'Телефон',
    '[[pdoMenu?
	&parents=`14`
	&level=`1`
	&showHidden=`0`
    ...
    '[[$lang? &ru=`Copyright © 2018 Все права защищены.` &lt=`Copyright  2019 Visos teisės saugomos.`]]' => 'Copyright © 2018 Все права защищены.',
    '[[$footer]]' => '        <!--footer-->
        <div class="stripcontact container">
			<div class="stripcontwrp">
				<ul class="clearfix">
...
',
    '[[$lang? &ru=`Перезвоните мне` &lt=`Paskambink man`]]' => 'Перезвоните мне',
    '[[~32? &scheme=`full`]]' => 'http://greenlubos.lt/natyazhnyie-potolki/potolki-s-fotopechatyu',
    '[[$lang? &ru=`Тема обращения` &lt=`Tema kreipimosi`]]' => 'Тема обращения',
    '[[$lang? &ru=`Отправить` &lt=`Siųsti`]]' => 'Отправить',
    '[[$lang? &ru=`Связаться с нами` &lt=`Susisiekite su mumis`]]' => 'Связаться с нами',
    '[[$lang? &ru=`Закрыть` &lt=`Uždaryti`]]' => 'Закрыть',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
