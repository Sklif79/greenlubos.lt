<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Глянцевые потолки',
    'longtitle' => '',
    'description' => '',
    'alias' => 'glyanczevyie-potolki',
    'alias_visible' => 0,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>это эффективный способ отделки помещений. Глянец имеет способность отражать и существенно увеличивать визуально пространство. Грамотный монтаж экономит освещение и мощность осветительных приборов. Глянцевые потолки – выход из ситуации, когда комната небольшая и требуется ее визуальное увеличение. Подбирая бюджетный материал для декорирования потолка среди доступного на сайте ассортимента, хозяева с хорошим вкусом изучают материал, который предлагается отечественными производителями.</p>

<p>Покупателей привлекает не только низкая стоимость глянцевого натяжного потолка, а и ряд его достоинств.</p>
',
    'richtext' => 1,
    'template' => 6,
    'menuindex' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'natyazhnyie-potolki/glyanczevyie-potolki',
    'uri_override' => 0,
    ...
    array (
      0 => 'images',
      1 => 'фото потолков/51086994_2873982579282358_5792249163752144896_n.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'opiskateg',
      1 => '<h4>Глянцевые натяжные потолки</h4>

<ul>
	<li>
	<p>Количество цветов: 150</p>
	</li>
	<li>
	<p>Ширина: 1,3-5,5 м</p>
	</li>
	<li>
	<p>Зеркальность 95%</p>
	</li>
	<li>
	<p>Прочность более 100кг/м2</p>
	</li>
</ul>
',
      2 => 'default',
    ...
    array (
      0 => 'slidePotol',
      1 => '[{"MIGX_id":"1","slider_potol":"фото потолков/50709898_1081749242027802_6537416059643756544_n.jpg","active_potol":"1"},{"MIGX_id":"2","slider_potol":"фото потолков/50886398_385627475329955_4633940803788472320_n.jpg","active_potol":"1"},{"MIGX_id":"3","slider_potol":"фото потолков/50767770_2305122899511800_9209887793755455488_n.jpg","active_potol":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'posledRaboty',
      1 => '[{"MIGX_id":"1","slider_Raboty":"photo_2019-02-10_20-30-22.jpg","active_Raboty":"1"},{"MIGX_id":"2","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e \\u043f\\u043e\\u0442\\u043e\\u043b\\u043a\\u043e\\u0432\\/1518780762614.jpg","active_Raboty":"1"},{"MIGX_id":"3","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e \\u043f\\u043e\\u0442\\u043e\\u043b\\u043a\\u043e\\u0432\\/1520533720190.jpg","active_Raboty":"1"},{"MIGX_id":"4","slider_Raboty":"\\u0444\\u043e\\u0442\\u043e \\u043f\\u043e\\u0442\\u043e\\u043b\\u043a\\u043e\\u0432\\/1520533743461.jpg","active_Raboty":"1"},{"MIGX_id":"5","slider_Raboty":"photo_2019-02-10_20-27-14.jpg","active_Raboty":"1"},{"MIGX_id":"6","slider_Raboty":"photo_2019-02-10_20-26-05.jpg","active_Raboty":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'texts',
      1 => 'Наиболее удачно глянцевые потолки смотрятся в следующих помещениях<br />
<strong>В кухню - В коридор - В ванную - В санузел</strong>',
    ...
    array (
      0 => 'texts2',
      1 => '<p style="text-align: justify;">Подбирая бюджетный материал для декорирования потолка среди доступного на сайте ассортимента, хозяева с хорошим вкусом изучают виды предлагаемых ответственными производителями глянцевых натяжных потолков. Покупателей привлекает не только низкая стоимость глянцевого натяжного потолка, а и ряд его достоинств.</p>
',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
...
<link rel="canonical" href="http://greenlubos.lt/natyazhnyie-potolki/glyanczevyie-potolki" />
<title>Глянцевые потолки</title>
...
<li class="woo-login landing_footer_menu_list_language_link_wrapper current-menu-item current_page_item">
    <a href="http://greenlubos.lt/natyazhnyie-potolki/glyanczevyie-potolki" class="ru babellinks item">
...
<li class="woo-login landing_footer_menu_list_language_link_wrapper ">
    <a href="http://greenlubos.lt/lt/blizgios-lubos" class="lt babellinks item">
...
<section class="page-title" >
   <div class="container">
      <div class="row">
         <div class="col-xs-12">
            <h2>Глянцевые потолки</h2>
<ol class="breadcrumb"><li><a href="/">Главная</a></li> / <li><a href="natyazhnyie-potolki/">Потолки</a></li> / <li>Глянцевые потолки</li></ol>	
         </div>
      </div>
   </div>
</section>
...
[[!AjaxForm?
    ...
    &formName=`Сообщение Глянцевые потолки`
	...
	&successMessage=`Ваша заявка принята! Наш менеджер свяжется с вами в ближайшее время.`
      ...
      <div class="service-content">
         ...
         <p>это эффективный способ отделки помещений. Глянец имеет способность отражать и существенно увеличивать визуально пространство. Грамотный монтаж экономит освещение и мощность осветительных приборов. Глянцевые потолки – выход из ситуации, когда комната небольшая и требуется ее визуальное увеличение. Подбирая бюджетный материал для декорирования потолка среди доступного на сайте ассортимента, хозяева с хорошим вкусом изучают материал, который предлагается отечественными производителями.</p>

<p>Покупателей привлекает не только низкая стоимость глянцевого натяжного потолка, а и ряд его достоинств.</p>

         <blockquote>Наиболее удачно глянцевые потолки смотрятся в следующих помещениях<br />
...
<div class="col-sm-6 col-md-4">
         ...
         <div class="list-frame row">
            <div class="col-sm-4">
               <h4>Глянцевые натяжные потолки</h4>
...
<ul>
	...
	<p>Прочность более 100кг/м2</p>
            ...
            <div class="col-sm-4">
               <img src="/assets/cache_image/фото потолков/51086994_2873982579282358_5792249163752144896_n_360x215_708.jpg" alt="Глянцевые потолки">
            </div>
            <div class="col-sm-4">
               <p style="text-align: justify;">Подбирая бюджетный материал для декорирования потолка среди доступного на сайте ассортимента, хозяева с хорошим вкусом изучают виды предлагаемых ответственными производителями глянцевых натяжных потолков. Покупателей привлекает не только низкая стоимость глянцевого натяжного потолка, а и ряд его достоинств.</p>
    ...
    <div class="preletitem">
                        <img src="/assets/cache_image/photo_2019-02-10_20-30-22_285x190_109.jpg" alt="Глянцевые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фото потолков/1518780762614_285x190_109.jpg" alt="Глянцевые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фото потолков/1520533720190_285x190_109.jpg" alt="Глянцевые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/фото потолков/1520533743461_285x190_109.jpg" alt="Глянцевые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/photo_2019-02-10_20-27-14_285x190_109.jpg" alt="Глянцевые потолки" />
                    </div>
    <div class="preletitem">
                        <img src="/assets/cache_image/photo_2019-02-10_20-26-05_285x190_109.jpg" alt="Глянцевые потолки" />
                    </div>
                </div>
...
',
    ...
    '[[~16? &scheme=`full`]]' => 'http://greenlubos.lt/natyazhnyie-potolki/glyanczevyie-potolki',
